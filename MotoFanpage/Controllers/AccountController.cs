...
namespace MotoFanpage.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(Profil model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Dodac do view CRUD z reeszta danych do profilu!!!

                    SendMail("Tomekkrynicki30@gmail.com", "Activation Mail", "Test");
